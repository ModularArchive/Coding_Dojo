from datetime import datetime #Had to get help for a few of these assignments but I loved learning them!
...
def take_call():
    ...
    num = raw_input()
    print "Please stay on the line while we process your call"
