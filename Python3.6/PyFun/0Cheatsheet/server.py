...
print('Outside of the function'copy)

#For these examples go into python script

age.__class__ #The .__class__ is used to determines the type of value (Int, float, etc)

#if you type name = "Scott"
#Followed by name or print name it should show "Scott"
